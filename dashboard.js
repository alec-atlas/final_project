...
async function renderDriver(driver) {
  document.querySelector('.drivers').insertAdjacentHTML('beforeend', `
    <div class=".driver-${driver.id} p-4 md:w-1/3 w-full h-full">
      <div class="border-2 border-yellow-500 p-4 flex flex-col bg-gray-50">
        ...
        <div class="mb-4 text-gray-900">${driver.bio}</div>
